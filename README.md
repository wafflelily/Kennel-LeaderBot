...
- **Gauntle** parses per-category times with bonus/penalty adjustments (including the skip penalty) into *effective* times, and infers the run's year as whichever candidate year puts the stated date closest to the post date.
